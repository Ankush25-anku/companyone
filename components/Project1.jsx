                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline loading__item">
                      <h1 className="inner-headline__title headline-img-after headline-img-03">
                        Explore our ERP systems, websites, and digital solutions
                        built for growth
                      </h1>

                      {/* 
                <p className="inner-headline__text t-large t-bright">
                  School ERP System complete management solution for institutions.
                  Business ERP Platform streamlining operations with smart tools.
                  Custom Website Development modern responsive business websites.
                  Web Application System scalable digital solutions for businesses.
                  Digital Solutions & Automation improving workflow and productivity.
                </p>
                */}
                    </div>
                  </div>
