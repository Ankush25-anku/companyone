                ...
                <div className="mxd-promo__content">
                  <p className="mxd-promo__title anim-uni-in-up">
                    ...
                    <span className="mxd-promo__caption reveal-type">
                      Build modern responsive business websites with
                      professional UI/UX design, fast performance, mobile
                      responsiveness, scalable architecture and engaging digital
                      experiences that help businesses grow their online
                      presence.
                    </span>
                  </p>
...
export default Projectdetails11;
