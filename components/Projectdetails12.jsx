              ...
              <div className="row g-0">
                ...
                <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                  <div className="inner-headline__paragraph loading__item">
                    <p>
                      Scalable digital solutions for businesses designed to
                      streamline operations, improve efficiency, automate
                      workflows, and deliver secure, high-performance web
                      applications for modern organizations.
                    </p>
                  </div>
                        ...
                        <div className="row g-0">
                          <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                            <div className="mxd-data-list__item">
                              <p className="mxd-data-list__name">Project</p>
                          ...
                          <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                            ...
                            <div className="mxd-data-list__item">
                              <p className="mxd-data-list__name">Platform</p>
...
export default Projectdetails12;
