              ...
              <div className="marquee__toright">
                ...
                <div className="marquee__item one-line item-regular text">
                  <p className="marquee__text">
                    School ERP System • Complete management solution for
                    institutions
                  </p>
                ...
                <div className="marquee__item one-line item-regular text">
                  <p className="marquee__text">
                    Business ERP Platform • Streamlining operations with smart
                    tools
                  </p>
                ...
                <div className="marquee__item one-line item-regular text">
                  <p className="marquee__text">
                    Custom Website Development • Modern responsive business
                    websites
                  </p>
